...
Rails.application.configure do
  config.hosts << /.*\.loca\.lt$/ # local tunnel
  config.hosts << /.*\.lhr\.life$/ # locahost.run
  config.hosts << /.*\.trycloudflare\.com$/ # cloudflare tunnel
  ...
  #   user_name: "3546ecf104de58",
  #   password: "06b86214d2762e",
